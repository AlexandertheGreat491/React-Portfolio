    ...
    <section className='row'>
        <div className='col'>
            ...
            <div className='col mt-2 border border-dark border-4 rounded'>
                ...
                Innovative problem-solver who is passionate about developing apps with a focus on mobile-first design and development and is currently completing a full-stack web development bootcamp through the University of Minnesota. Strengths in creativity, teamwork, and building projects, and customer service.
                </p>
            </div>
        </div>
    </section>
